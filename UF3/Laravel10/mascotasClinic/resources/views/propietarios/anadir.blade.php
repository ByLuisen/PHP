...
@section('content')
    <form method="post" action="">
        ...
        <div class="form-group form-inline"> NIF *:
            <input contentEditable="false" type="text" placeholder="NIF" name="nif"
        ...
        <div class="form-group form-inline"> Email *:
            <input type="text" placeholder="Email" name="email" value="<?php if (isset($content)) {
                echo $content->getEmail();
            } ?>">
        </div>

        <div class="form-group form-inline"> Phone *:
            <input type="text" placeholder="Phone" name="phone" value="<?php if (isset($content)) {
                echo $content->getPhone();
            } ?>">
        </div>
