...
/**
 * Redirige a una localización en concreto
 * 
 * @param string $url localización a la cual se quiere redirigir
 */
...
/**
 * Redirige a una localización con unos datos convertidos en variables session.
 * 
 * @param string $url  Localización a la cual se quiere redirigir.
 * @param array $items Datos que se quieren convertir en variables session.
 */
