        ...
        <nav class="navbar navbar-expand-lg border-bottom border-2 border-black mb-5">
            <div class="container">
                <a class="navbar-brand" href="home.php">
                    <img src="img/1.png" alt="Logo" width="30" height="30" class="d-inline-block align-text-top">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="juego1.php">Juego 1</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="juego2.php">Juego 2</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="juego3.php">Juego 3</a>
                        </li>
                    </ul>
                </div>
            </div>
