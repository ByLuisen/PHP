...
setcookie('estil', '{{estil}}', time() + (86400 * 30), "/"); // Cookie válida por 30 días
require_once('src/functions-structure.php');
require_once('src/functions.php');
myHead('{{contenido}}');

$estil = isset($_COOKIE['estil']) && $_COOKIE['estil'] === '{{estil}}' ? $_COOKIE['estil'] : '{{estil}}';
$colorFondo = '';
$tamanoLetra = '';
